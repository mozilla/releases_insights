...
class API
{
     ...
     *
     * @return bool True if valid request, False if invalid request
     */
     ...
     *
     * @return bool Returns True if we have a valid service call, False otherwise
     */
     ...
     *
     * @return bool True if we can satisfy the request, False if we can't
     */
     ...
     * @param bool   $alias      Do we allow aliases for repository names,
     *                           ex: 'global', to query all repositories. Default to False
     *
     * @return bool True if we support this repository, False if we don't
     */
     ...
     *
     * @return bool True if we support the locale, False if we don't
     */
     ...
     *
     * @return bool True if the service called is valid, False otherwise
     */
     ...
     *
     * @return bool True if we logged, False if we didn't log
     */
