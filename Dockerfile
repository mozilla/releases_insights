...
RUN curl https://github.com/mlocati/docker-php-extension-installer/releases/download/2.10.18/install-php-extensions \
...
FROM php:8.5-fpm-alpine3.23 AS runner
